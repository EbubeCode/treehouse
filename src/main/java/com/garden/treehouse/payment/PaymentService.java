package com.garden.treehouse.payment;
...
public class PaymentService {
    ...
    private void addRaveDetailsToPayload(Payload payload, Long id) {
        String txRef = UUID.randomUUID().toString();
        payload.setPublic_key(ravePublicKey);
        payload.setTx_ref(txRef);
        payload.setRedirect_url("/callback/"+ id);
    }
